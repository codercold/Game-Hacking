...
public:
	...
	virtual void Begin()
	{
		...
		if (!pFont)
		{
			if( D3DXCreateFont(pDevice, 16, 0, FW_NORMAL, 1, FALSE, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE, "Courier New", &pFont) != D3D_OK ) 
				return;
		}
