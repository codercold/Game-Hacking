...
//
//   // LOQ("PpOll", "FileHandle", FileHandle, "DesiredAccess", DesiredAccess, "FileName", ObjectAttributes, "CreateDisposition", CreateDisposition, "ShareAccess", ShareAccess);
//
...
//
//    //LOQ("PpOl", "FileHandle", FileHandle, "DesiredAccess", DesiredAccess, "FileName", ObjectAttributes, "ShareAccess", ShareAccess );
//
//    if( NT_SUCCESS(ret) && DesiredAccess & DUMP_FILE_MASK ) 
//	{
//        //handle_new_file(*FileHandle, ObjectAttributes);
...
//    __in_opt  PULONG Key
//){
//    NTSTATUS ret = Old_NtReadFile( FileHandle, Event, ApcRoutine, ApcContext, IoStatusBlock, Buffer, Length, ByteOffset, Key );
//
//    //LOQ("pb", "FileHandle", FileHandle, "Buffer", IoStatusBlock->Information, Buffer );
//
//    return ret;
//}
//
...
//){
//    NTSTATUS ret = Old_NtDeviceIoControlFile( FileHandle, Event, ApcRoutine, ApcContext, IoStatusBlock, IoControlCode, InputBuffer, InputBufferLength, OutputBuffer, OutputBufferLength );
//
//    //LOQ("pbb", "FileHandle", FileHandle, "InputBuffer", InputBufferLength, InputBuffer, "OutputBuffer", IoStatusBlock->Information, OutputBuffer );
//
//    return ret;
//}
//
...
//){
//    NTSTATUS ret = Old_NtQueryDirectoryFile( FileHandle, Event, ApcRoutine, ApcContext, IoStatusBlock, FileInformation, Length, FileInformationClass, ReturnSingleEntry, FileName, RestartScan );
//
//    //LOQ("pbo", "FileHandle", FileHandle, "FileInformation", IoStatusBlock->Information, FileInformation, "FileName", FileName );
//
//    return ret;
//}
//
...
//    __in   FILE_INFORMATION_CLASS FileInformationClass
//){
//    NTSTATUS ret = Old_NtQueryInformationFile( FileHandle, IoStatusBlock, FileInformation, Length, FileInformationClass );
//
//    //LOQ( "pb", "FileHandle", FileHandle, "FileInformation", IoStatusBlock->Information, FileInformation );
//
//	return ret;
//}
//
...
//    }
//
//    NTSTATUS ret = Old_NtSetInformationFile( FileHandle, IoStatusBlock, FileInformation, Length, FileInformationClass );
//    
//	//LOQ( "pb", "FileHandle", FileHandle, "FileInformation", IoStatusBlock->Information, FileInformation );
//
//    return ret;
...
//    __in   POBJECT_ATTRIBUTES ObjectAttributes
//){
//    NTSTATUS ret = Old_NtOpenDirectoryObject( DirectoryHandle, DesiredAccess, ObjectAttributes );
//
//    //LOQ( "PlO", "DirectoryHandle", DirectoryHandle, "DesiredAccess", DesiredAccess, "ObjectAttributes", ObjectAttributes );
//
//    return ret;
//}
//
...
//    __in   POBJECT_ATTRIBUTES ObjectAttributes
//){
//    NTSTATUS ret = Old_NtCreateDirectoryObject( DirectoryHandle, DesiredAccess, ObjectAttributes );
//
//    //LOQ( "PlO", "DirectoryHandle", DirectoryHandle, "DesiredAccess", DesiredAccess, "ObjectAttributes", ObjectAttributes );
//
//    return ret;
...
//    //IS_SUCCESS_BOOL();
//
//    BOOL ret = Old_CreateDirectoryExW( lpTemplateDirectory, lpNewDirectory, lpSecurityAttributes );
//
...
//    //IS_SUCCESS_BOOL();
//
//    BOOL ret = Old_MoveFileWithProgressW( lpExistingFileName, lpNewFileName, lpProgressRoutine, lpData, dwFlags );
//
//    //LOQ( "uu", "ExistingFileName", lpExistingFileName, "NewFileName", lpNewFileName );
//
//    if(ret != FALSE)
//	{
...
//    //IS_SUCCESS_HANDLE();
//
//    HANDLE ret = Old_FindFirstFileExA( lpFileName, fInfoLevelId, lpFindFileData, fSearchOp, lpSearchFilter, dwAdditionalFlags );
//
...
//    //IS_SUCCESS_HANDLE();
//
//    HANDLE ret = Old_FindFirstFileExW( lpFileName, fInfoLevelId, lpFindFileData, fSearchOp, lpSearchFilter, dwAdditionalFlags );
//
...
//    //IS_SUCCESS_BOOL();
//
//    BOOL ret = Old_CopyFileA( lpExistingFileName, lpNewFileName, bFailIfExists );
//
//    //LOQ( "ss", "ExistingFileName", lpExistingFileName, "NewFileName", lpNewFileName );
//
//    return ret;
//}
//
...
//    //IS_SUCCESS_BOOL();
//
//    BOOL ret = Old_CopyFileW( lpExistingFileName, lpNewFileName, bFailIfExists );
//
//    //LOQ("uu", "ExistingFileName", lpExistingFileName, "NewFileName", lpNewFileName );
//
//    return ret;
...
//    //IS_SUCCESS_BOOL();
//
//    BOOL ret = Old_CopyFileExW( lpExistingFileName, lpNewFileName, lpProgressRoutine, lpData, pbCancel, dwCopyFlags );
//
//    //LOQ( "uul", "ExistingFileName", lpExistingFileName, "NewFileName", lpNewFileName, "CopyFlags", dwCopyFlags );
//
//    return ret;
//}
//
