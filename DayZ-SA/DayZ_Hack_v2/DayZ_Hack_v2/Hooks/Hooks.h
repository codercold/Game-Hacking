...
//extern FILE* file;
extern VOID WINAPIV Log( CHAR* szFormat, ... );
extern hook_t g_hooks[];
extern DWORD* VTablePointer;
...
//extern HOOKDEF(int, WINAPI, send,
//		_In_ SOCKET s,
//		_In_ const char *buf,
//		_In_ int len,
//		_In_ int flags
//);
//
//extern HOOKDEF(int, WINAPI, recv,
//		_In_ SOCKET s,
//		_Out_ char *buf,
//		_In_ int len,
//		_In_ int flags
...
//extern HOOKDEF( HRESULT, WINAPI, Present,
